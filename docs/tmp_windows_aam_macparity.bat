...
set "BASE=-e windows -u DENA -s TRLA -y 2025 -l 1500 --headings 0 --omni-min 0 --omni-max 0 --density 10 --cleanup --annotation-file DENATRLA2025_saved_annotations.geojson"
