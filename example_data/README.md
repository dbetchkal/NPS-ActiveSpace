...
On Mac/Linux, run the full NMSim pipeline via [docker/README.md](../docker/README.md) (`-e container`).
Use `-e DENA_example` / `-e GLBA_example` for native ground-truthing and viz only.
